...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Orthopaedics.css?v=<?php echo time(); ?>">
    ...
    <body>
        ...
        <div class="captionBanner">
            <img src="Orthopaedics.jpg" alt="" height="100%" width="auto">
        </div>
        ...
        <?php
            $con = mysqli_connect('localhost','root',NULL,'hospital_database');
            $sql = "SELECT  Doc_Id , Name , Image , Fees , Exp_years FROM doctor_details WHERE Specialization='Orthopaedics'";
