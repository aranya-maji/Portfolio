...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Infertility medicine.css?v=<?php echo time(); ?>">
    ...
    <body>
        ...
        <div class="captionBanner">
            <img src="Infertilty medicine.jpg" alt="" height="200%" width="auto">
        </div>
        <div class="captionTextArea">

        </div>
        <div class="captionText">
            Interfility Medicine
        </div>
        <?php
            $con = mysqli_connect('localhost','root',NULL,'hospital_database');
            $sql = "SELECT  Doc_Id , Name , Image , Fees , Exp_years FROM doctor_details WHERE Specialization='Infertility medicine'";
