...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Paediatrics.css?v=<?php echo time(); ?>">
    ...
    <body>
        ...
        <div class="captionBanner">
            <img src="Paediatrics.jpg" alt="" height="175%" width="auto" style="padding-top: -20px;">
        </div>
        ...
        <?php
            $con = mysqli_connect('localhost','root',NULL,'hospital_database');
            $sql = "SELECT  Doc_Id , Name , Image , Fees , Exp_years FROM doctor_details WHERE Specialization='Paediatrics'";
