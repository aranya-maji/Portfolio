...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Ophthalmology.css?v=<?php echo time(); ?>">
    ...
    <body>
        ...
        <div class="captionBanner">
            <img src="Ophthalmology.jpg" alt="" height="175%" width="auto" style="padding-top: -30px;">
        </div>
        ...
        <?php
            $con = mysqli_connect('localhost','root',NULL,'hospital_database');
            $sql = "SELECT  Doc_Id , Name , Image , Fees , Exp_years FROM doctor_details WHERE Specialization='Ophthalmology'";
